                    ...
                    >
                        {reviews.map((r, index) => {
                            ...
                            return (
                                ...
                                >
                                    <Card className="border-orange-300 bg-orange-100 shadow-sm transition-all duration-200 hover:border-orange-400 hover:shadow-md">
                                        <CardContent className="p-3">
                                            <div className="flex items-start gap-2.5">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    {/*Review body with optional read more toggle*/}
                                                    <div className="mt-3 border-t border-orange-200 pt-2">
                                                        ...
                                                        {isLongReview && (
                                                            <button
                                                                ...
                                                                className="mt-1.5 text-sm font-medium text-orange-700 transition-colors duration-150 hover:text-orange-800"
                                                            >
